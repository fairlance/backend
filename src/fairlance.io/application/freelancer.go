...
func updateFreelancerByID() http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		freelancer.IsAvailable = freelancerUpdate.IsAvailable
		freelancer.HourlyRateFrom = freelancerUpdate.HourlyRateFrom
		freelancer.HourlyRateTo = freelancerUpdate.HourlyRateTo
