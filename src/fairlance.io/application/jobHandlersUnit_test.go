...
func TestJob(t *testing.T) {
	...
	t.Run("index handler with error", func(t *testing.T) {
		jobRepositoryMock := JobRepositoryMock{}
	...
	t.Run("get job by ID with the right ID", func(t *testing.T) {
		jobRepositoryMock := JobRepositoryMock{}
		var jobContext = &ApplicationContext{
			JobRepository: &jobRepositoryMock,
		}
		...
		GetJobByID(uint(1)).ServeHTTP(w, r)
	...
	t.Run("get job by ID", func(t *testing.T) {
		...
		GetJobByID(uint(0)).ServeHTTP(w, r)
	...
	t.Run("get job by ID with error", func(t *testing.T) {
		jobRepositoryMock := JobRepositoryMock{}
	...
	t.Run("add job with error", func(t *testing.T) {
		jobRepositoryMock := JobRepositoryMock{}
	...
	t.Run("apply for job", func(t *testing.T) {
		jobRepositoryMock := JobRepositoryMock{}
		var jobContext = &ApplicationContext{
			JobRepository: &jobRepositoryMock,
		}
	...
	t.Run("apply for job with error", func(t *testing.T) {
		jobRepositoryMock := JobRepositoryMock{}
	...
	t.Run("withJob with error", func(t *testing.T) {
		var jobContext = &ApplicationContext{}
		is := is.New(t)
		w := httptest.NewRecorder()
		requestBody := `{}`
	...
	t.Run("withJob with error because of too many tags", func(t *testing.T) {
		var jobContext = &ApplicationContext{}
		is := is.New(t)
		w := httptest.NewRecorder()
		requestBody := `{
	...
	t.Run("withJob with error because of bad JSON", func(t *testing.T) {
		var jobContext = &ApplicationContext{}
		is := is.New(t)
		w := httptest.NewRecorder()
	...
	t.Run("withJobApplication", func(t *testing.T) {
		var jobContext = &ApplicationContext{}
		is := is.New(t)
		w := httptest.NewRecorder()
		requestBody := `{
	...
	t.Run("withJobApplication with empty JSON body", func(t *testing.T) {
		var jobContext = &ApplicationContext{}
		is := is.New(t)
		w := httptest.NewRecorder()
		requestBody := `{}`
	...
	t.Run("withJobApplication with error because of bad JSON", func(t *testing.T) {
		var jobContext = &ApplicationContext{}
		is := is.New(t)
		w := httptest.NewRecorder()
		requestBody := `{bad:json}`
