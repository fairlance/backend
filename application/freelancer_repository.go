...
func (repo *PostgreFreelancerRepository) GetAllFreelancers() ([]Freelancer, error) {
	...
	if err := repo.db.Preload("Projects").Preload("Projects.Client").Preload("References").Preload("References.Media").Preload("Reviews").Preload("Reviews.Client").Find(&freelancers).Error; err != nil {
...
func (repo *PostgreFreelancerRepository) GetFreelancer(id uint) (Freelancer, error) {
	...
	if err := repo.db.Preload("Projects").Preload("Projects.Client").Preload("References").Preload("References.Media").Preload("Reviews").Preload("Reviews.Client").Find(&freelancer, id).Error; err != nil {
